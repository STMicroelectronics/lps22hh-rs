...
mod mode {
    ...
    pub use lps22hh_rs::asynchronous as lps22hh;
...
mod mode {
    ...
    pub use lps22hh_rs::blocking as lps22hh;
    pub use cortex_m_rt::interrupt;
}

pub use mode::*;
pub use lps22hh::I2CAddress;
...
define_embassy_with_st_link! {
    i2c = {
        address: I2CAddress::AddressH as u8,
        periph: I2C1,
        scl: PB8,
        sda: PB9,
        ev_irq: I2C1_EV,
